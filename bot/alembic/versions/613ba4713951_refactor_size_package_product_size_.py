"""refactor size_package product_size_package relationship

Revision ID: 613ba4713951
Revises: 45d478c4a36b
Create Date: 2025-10-02 10:19:31.773972
...
revision: str = '613ba4713951'
down_revision: Union[str, Sequence[str], None] = '45d478c4a36b'
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('product_size_packages_product_size_id_fkey'), 'product_size_packages', type_='foreignkey')
    op.drop_constraint(op.f('product_size_packages_package_id_fkey'), 'product_size_packages', type_='foreignkey')
    op.create_foreign_key(None, 'product_size_packages', 'product_sizes', ['product_size_id'], ['id'], source_schema='public', referent_schema='public', ondelete='CASCADE')
    op.create_foreign_key(None, 'product_size_packages', 'packages', ['package_id'], ['id'], source_schema='public', referent_schema='public', ondelete='CASCADE')
    ...
    op.add_column('sizes', sa.Column('package_id', sa.Integer(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('sizes', 'package_id')
    ...
    op.drop_constraint(None, 'product_size_packages', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'product_size_packages', schema='public', type_='foreignkey')
    op.create_foreign_key(op.f('product_size_packages_package_id_fkey'), 'product_size_packages', 'packages', ['package_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('product_size_packages_product_size_id_fkey'), 'product_size_packages', 'product_sizes', ['product_size_id'], ['id'], ondelete='CASCADE')
