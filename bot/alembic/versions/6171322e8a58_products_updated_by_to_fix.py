"""products.updated_by to fix

Revision ID: 6171322e8a58
Revises: 613ba4713951
Create Date: 2025-10-09 15:47:06.670395
...
revision: str = '6171322e8a58'
down_revision: Union[str, Sequence[str], None] = '613ba4713951'
...
def upgrade() -> None:
    ...
    op.add_column('products', sa.Column('updated_by', sa.BIGINT(), nullable=True))
    ...
    op.create_foreign_key(None, 'products', 'users', ['updated_by'], ['tg_user_id'], source_schema='public', referent_schema='public', ondelete='CASCADE')
    ...
    op.alter_column('sizes', 'package_id',
